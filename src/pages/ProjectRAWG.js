...
import coverLong from "../img/ignite.gif";
import styled from "styled-components";
import { motion } from "framer-motion";
import { pageAnimation, fade, photoAnim, lineAnim } from "../animation";
import { useTranslation } from "react-i18next";

export default function ProjectRAWG() {
	const { t } = useTranslation();
	return (
		<Main variants={pageAnimation} initial='hidden' animate='show' exit='exit'>
			<motion.h2 variants={fade}>RAWG API</motion.h2>
			...
			<div className='container'>
				...
				<Text className=''>
					...
					<p></p>
					<a target='_blank' rel='noreferrer' href='https://rawg.netlify.com'>
						Live Demo
					</a>
